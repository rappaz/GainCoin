...
const GainToken = artifacts.require("./GainToken");

var becomesTransferable = 1508249410; // GainToken.sol:22
var lockingPeriod = 604800;           // GainToken.sol:26

contract('GainToken', function(accounts) {
  ...
  it("the first account has all tokens except Owner tokens", async () => {
    token = await GainToken.deployed()
