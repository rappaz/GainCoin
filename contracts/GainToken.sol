...
/** @title The Gain Token
  ...
  */
contract GainToken is StandardToken, Pausable {
    ...
    /** @dev Constructor for the contract.
      ...
      */
    function GainToken(address _deployer, address _owner, uint256 _balance)
        Pausable() {
